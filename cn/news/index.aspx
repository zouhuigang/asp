<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.news.index" %>
...
<%@ Register Src="~/cn/news/news_left.ascx" TagPrefix="uc1" TagName="news_left" %>
...
<table width="1160" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    <td width="275" align="left" valign="top" style=" padding-top:25px;">
        <uc1:news_left runat="server" ID="news_left" />
 
	</td>
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">航空快讯</td>
      </tr>
      <tr>
      ...
      <tr>
        <td ><table width="885" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top"><table width="98%" border="0" align="left" cellpadding="0" cellspacing="0" style="margin-bottom:20PX;" >
              <tr>
                <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                <td align="left" valign="top" style="padding-top:10px;" ><table width="95%" border="0" cellspacing="0" cellpadding="0">
                    <asp:Repeater ID="Repeater2" runat="server">
                        <ItemTemplate>
<tr>
                    <td width="33%" align="left"><img src="../../<%# Eval("Image") %>" width="254" height="187" /></td>
                    <td width="67%" align="left" valign="top"> <strong class="zi10"><%# Eval("Subject") %></strong><br />
                      <%# Convert.ToDateTime(Eval("CreateDate")).ToString("yyyy.MM.dd") %> <p><%# Eval("Description") %>... <br />
                        <br />
                        <a href="content.aspx?Id=<%# Eval("Id") %>" class="aa">[了解详情]</a></p></td>
                  </tr>
                        </ItemTemplate>
                    </asp:Repeater>
