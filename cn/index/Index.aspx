<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.index.Index" %>
...
<div class="search"  style="z-index:10;">
  <table width="100%" border="0" cellspacing="0" cellpadding="0">
    <tr>
      <td height="30"  style="color:#FFFFFF">　快速搜寻</td>
    </tr>
	...
	<div class='allsort'>
		<div class='mc'>
			<div class='item fore'>
				<span style="background:url(../../images/bg1.jpg) no-repeat 0px 0px;"><h3><a href="" style="font-size:16px;" id="typel">飞机类型</a></h3><s></s></span>
   ...
   <tr>
     <td colspan="6" height="80"  class="zi8"><strong>选择飞机类型</strong></td>
   </tr>
   <tr>
       <asp:Repeater ID="Repeater1" runat="server">
           <ItemTemplate>
<td width="120" align="center"><a href="#" onclick="setType('<%#Eval("Name") %>')"><img src="../../<%# Eval("Image") %>" border="0" /></a></td>
           </ItemTemplate>
       </asp:Repeater>
   ...
   <tr>
       ...
       <ItemTemplate>
           <td height="30" align="center"><a href="#" onclick="setType('<%#Eval("Name") %>')"><%# Eval("Name") %></a></td>
       </ItemTemplate>
        </asp:Repeater>
			...
			<div class='item'>
				<span  style="background:url(../../images/bg2.jpg) no-repeat 0px 0px;"><h3><a href="" style="font-size:16px;" id="Manufacturerl">飞机制造商</a></h3><s></s></span>
  ...
  <tr> <td colspan="5" height="50"  class="zi8"><strong>选择飞机制造商</strong></td>
  </tr>
  <tr>
    <td width="502" valign="top">
        <%
            ...
            if (AircraftManufacturerTable != null){ 
                ...
                {
                %>
        <a href="#" onclick="setM('<%= AircraftManufacturerTable.Rows[index]["Name"] %>')"><%= AircraftManufacturerTable.Rows[index]["Name"] %></a><br />
     <%
                    index = index + 1;
     }
    ...
    <td width="502" valign="top">
      ...
      <% if (AircraftManufacturerTable != null){
        ...
        index=index+1;
 			...
 			<div class='item'>
				<span  style="background:url(../../images/bg3.jpg) no-repeat 0px 0px;"><h3><a href="" style="font-size:16px;" id="priel">价格</a></h3><s></s></span>
   ...
   <tr>
     <td  colspan="2"  class="zi8"><strong>选择价格</strong></td>
     <td width="366"   rowspan="5" style="padding:20px 20px; border-left:#999999 solid 1px; font-size:13px;">中国大陆公务机机队数量将近300架，而中国大陆1420人目前都有购买公务机的潜力，购置公务机需求高达1750架，总价值超3400亿人民币。<br />
     这是民生金融租赁与胡润百富联手发布的《中国公务机行业特别报告》中公布的数据，不过，报告也指出，相比于欧美等发达国家来说，中国的私人飞机数量依然算少数，是什么阻碍了更多的富豪购买自己的私人飞机？</td>
   </tr>
    
     <tr>
     <td width="60">制造商：</td>
     <td width="210"><span id="Manufacturerl1">全部制造商</span></td>
   </tr>
   <tr>
     <td>型　号：</td>
     <td><select name="modulelist" id="modulelist" style="width:190px;" onchange="selectModule(this)">
   <option>全部型号</option>
   ...
   <tr>
    ...
    <asp:ListItem>5000万以上</asp:ListItem>
			...
			<div class='item'>
				<span  style="background:url(../../images/bg4.jpg) no-repeat 0px 0px;"><h3><a href="" style="font-size:16px;" id="Avionicsl">航空配备</a></h3><s></s></span>
  ...
  <tr> <td colspan="7" height="50"  class="zi8"><strong>选择航空配备</strong></td>
  </tr>
  <tr>
    <td>
          <%
             ...
             if (AvionicsTable != null)
             {
                 ...
                 while (index < 8 && index < AvionicsTable.Rows.Count)
                {
                %>
    ...
    <td>
          <% 
             if (AvionicsTable != null)
             {
                 ...
                 while (index < 16 && index < AvionicsTable.Rows.Count)
                {
                %>
        <a href="#" style="font-size:13px;" onclick="setAvionics('<%= AvionicsTable.Rows[index]["Name"] %>')"><%= AvionicsTable.Rows[index]["Name"] %></a><br />
     <%
    ...
    <td>
        <% 
             if (AvionicsTable != null)
             {
                 ...
                 while (index < 24 && index < AvionicsTable.Rows.Count)
                {
                %>
        <a href="#" style="font-size:13px;" onclick="setAvionics('<%= AvionicsTable.Rows[index]["Name"] %>')"><%= AvionicsTable.Rows[index]["Name"] %></a><br />
     <%
    ...
    <td>
         <% 
             if (AvionicsTable != null)
             {
                 ...
                 while (index < 32 && index < AvionicsTable.Rows.Count)
                {
                %>
        <a href="#" style="font-size:13px;" onclick="setAvionics('<%= AvionicsTable.Rows[index]["Name"] %>')"><%= AvionicsTable.Rows[index]["Name"] %></a><br />
     <%
 ...
 <script type="text/javascript">
     ...
     <tr>
      <td><a href="#" onclick="Search()"><img src="../../images/search.png"  alt="" width="195" height="46" border="0"/></a></td>
    </tr>
  </table>
 </div>
<!-- searchend-->
