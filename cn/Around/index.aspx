<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.Around.index" %>
...
<table width="1160" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">北美包机环游</td>
      </tr>
      <tr>
      ...
      <tr>
        <td >  
            <uc1:memoinfocontent runat="server" ID="memoinfocontent" Type="北美包机环游" />
