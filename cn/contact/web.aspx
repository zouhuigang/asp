<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.contact.web" %>
...
<!-- 代码部分begin -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">销售网络</td>
      </tr>
      <tr>
      ...
      <tr>
        <td ><table width="885" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td valign="top">
                <uc1:memoinfocontent runat="server" ID="memoinfocontent"  Type="销售网络"/>
            </td>
              </tr>
        </table></td>
      </tr>
