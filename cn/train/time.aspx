<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.train.time" %>
...
<!-- 代码部分begin -->
	<div id="content">
		<ul id="expmenu-freebie">
			<li>
				...
				<li>
						<div class="header">
							<span class="label"  style="padding-left:10px;">飞行驾驶培训</span>
 						</div>
						<ul class="menu" style="display:block">
							<li><a href="index.aspx" style="font-size:16px; color:#000000;"> 培训要求</a></li>
							<li> <a href="time.aspx" style="font-size:16px; color:#000000;">培训计划与时间</a></li>
						</ul>
				  </li>
				</ul>
				<!-- End Freebie -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">培训计划与时间</td>
      </tr>
      <tr>
        ...
        <td ><table width="885" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="padding:10px;">
                <uc1:memoinfocontent runat="server" ID="memoinfocontent"  Type="培训计划与时间"/>
            </td>
          </tr>
        </table></td>
      </tr>
