<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.train.index" %>
...
<!-- 代码部分begin -->
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">培训要求</td>
      </tr>
      <tr>
        ...
        <td ><table width="885" border="0" cellspacing="0" cellpadding="0">
          <tr>
            <td style="padding:10px;">
                <uc1:memoinfocontent runat="server" ID="memoinfocontent"  Type="培训要求"/>
            </td>
          </tr>
        </table></td>
      </tr>
