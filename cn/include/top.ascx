<%@ Control Language="C#" AutoEventWireup="true" CodeFile="top.ascx.cs" Inherits="cn_include_top" %>
...
#nav {line-height: 24px;  list-style-type: none;  width:840px; margin:0px; padding:0px; font-size:16px;}
#nav li{}
