<%@ Control Language="C#" AutoEventWireup="true" CodeFile="top_buy1.ascx.cs" Inherits="cn_include_top_buy1" %>
   <style type="text/css">
<!--
...
#nav li ul li{float: left; background:#EFEFEF;width: 170px;margin-left:-40px; border-bottom:#C9C9C9 1px solid;}


#nav li ul a{display: block; width: 146px;text-align:left;padding-left:24px; overflow:hidden; }
...
<div class="top">
  <table width="95%" border="0" align="center" cellpadding="0" cellspacing="0">
    <tr>
      ...
      <td width="20%" align="right" valign="top" style="padding-top:10px;">
          <table width="120" height="23" border="0" cellpadding="0" style="<%= Session["LoginId"]+""==""?"":"display:none" %>">
        <tr>
          <td width="14" valign="middle"><img src="../../images/img01.png" width="12" height="15"  alt=""/></td>
          <td width="35" valign="bottom"><a href="../club/registr.aspx" class="top1">注册</a></td>
          <td width="16" align="right" valign="middle"><img src="../../images/img02.png" width="16" height="14"  alt=""/></td>
          <td width="37" valign="bottom"><a href="../club/index.aspx" class="top1">登录</a></td>
        </tr>
      </table>
          <table width="120" height="23" border="0" cellpadding="0" style="<%= Session["LoginId"]+""==""?"display:none":"" %>">
        <tr>
          ...
          <td width="16" align="right" valign="middle"><img src="../../images/img02.png" width="16" height="14"  alt=""/></td>
          <td width="57" valign="bottom"><a href="../club/user.aspx" class="top1">会员中心</a></td>
        </tr>
      </table></td>
    </tr>
  </table>
