<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.cn.club.dz" %>
...
<table width="1160" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">定制服务</td>
      </tr>
      <tr>
      ...
      <tr>
        <td style="padding:10px;">
            <uc1:memoinfocontent runat="server" Type="定制服务" ID="memoinfocontent" />
        </td>
      </tr>
