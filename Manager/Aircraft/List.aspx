<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.Manager.Aircraft.List" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
                                ...
                                <table width="100%" cellSpacing="0" cellPadding="0" border="0">
                                    <tr>
										...
										<tr>  
                                            ...
                                            <td>
                                                <asp:TextBox ID="Title" style="margin-bottom:0px;" runat="server"></asp:TextBox>
                                                 
                                             </td>
                                            <td style="width:60px; text-align: center">
                                                <asp:Button ID="SearchButton" runat="server" Text="搜索" /></td>  
										</tr> 
                                        </table>
                                        </td>
                                    </tr>
                        ...
                        <ItemTemplate>
										<tr id='tr_<%# Eval("Id") %>'>  
                                            <td class="data-mun"><%# Eval("Manufacturer") %></td> 
                                            <td class="data-mun"><%# Eval("Model") %></td> 
                                            <td class="data-mun"><%# Eval("Year") %></td> 
                                            <td class="data-mun"><%# Eval("Subject") %></td> 
                                            <td class="data-mun"><%# Convert.ToBoolean( Eval("New"))?"是":"否" %></td> 
											<td class="data-act">
                                              <a href="ImageList.aspx?AircraftId=<%# Eval("Id") %>"><i class="icon-edit"></i> 图片管理</a>
                                            <a href="Edit.aspx?Id=<%# Eval("Id") %>"><i class="icon-edit"></i> 编辑</a>
