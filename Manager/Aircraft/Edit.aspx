<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.Manager.Aircraft.Edit" %>
								...
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
										...
										<div class="controls">
                                            <asp:TextBox ID="Description" runat="server" MaxLength="38" placeholder="" style="width:600px;" class="input-xlarge"></asp:TextBox>
										</div>
									</div> 
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                     ...
                                     <div class="control-group">
										<label for="textfield" class="control-label">视频地址2</label>
										<div class="controls"> 
                                    ...
                                    <div class="control-group">
										<label for="textfield" class="control-label">价格说明</label>
										<div class="controls">
                                            <asp:ListBox ID="PriceDescription" runat="server" Rows="1" class="input-xlarge" style="width:300px;">
                                                <asp:ListItem>请选择</asp:ListItem>
                                                <asp:ListItem>CIF抵中国海岸价(含美国出口拆解运送)</asp:ListItem>
                                                <asp:ListItem>CIF抵中国机场价(含美国出口运送费用)</asp:ListItem>
                                            </asp:ListBox>
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">机身/机仓</label>
                                            <div class="controls">
