<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.Manager.User.List" %>
					...
					<div class="span12">
                        ...
                        <ItemTemplate>
										<tr id='tr_<%# Eval("Id") %>'>
                                            ...
                                            <td class="data-mun"><%# Eval("Email") %></td>
                                            <td class="data-mun"><%# Eval("Sex") %></td>
                                            <td class="data-mun"><%# Eval("Telephone") %></td>
                                            <td class="data-mun"><%# Eval("WeChat") %></td>
                                            <td class="data-mun"><%# Eval("Birthday") %></td>
                                            <td class="data-mun"><%# Eval("Description") %></td>
