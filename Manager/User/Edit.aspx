<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.Manager.User.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									...
									<div class="control-group">
                                     ...
                                     <div class="control-group">
										<label for="textfield" class="control-label">邮箱</label>
										<div class="controls">
                                             <%= Email %>
										</div>
									</div>
                                     ...
                                     <div class="control-group">
										<label for="textfield" class="control-label">联系电话</label>
										<div class="controls">
                                             <%= Telephone %>
										</div>
									</div>
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">微信号</label>
                                            <div class="controls">
                                          <%= WeChat %>
										 </div>
									</div>
									  ...
									  <div class="control-group">  
                                        <label for="textfield" class="control-label">出生年月</label>
                                            <div class="controls">
                                          <%= Birthday %>
										 </div>
									</div>
                                     ...
                                     <div class="control-group">  
                                        <label for="textfield" class="control-label">登陆密码<br />不修改不需要填写</label>
                                            <div class="controls">
                                          <asp:TextBox ID="Password" runat="server" TextMode="Password" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										 </div>
									</div>
