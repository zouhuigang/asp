<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.Manager.AircraftManufacturer.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									...
									<div class="control-group">
                                     ...
                                     <div class="control-group">
										<label for="textfield" class="control-label">英文名</label>
										<div class="controls">
                                            <asp:TextBox ID="NameEn" runat="server" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										</div>
									</div> 
