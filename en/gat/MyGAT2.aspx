<%@ Page Language="C#" AutoEventWireup="true"   Inherits="Aircraft.Web.en.gat.MyGAT2" %>
...
<table width="1160" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td height="70" class="zi4">Manage and Edit My Ad</td>
      </tr>
      <tr>
              ...
              <tr>
                <td height="87" align="center" valign="middle">
                  ...
                  <tr>
                    ...
                    <td bgcolor="#E4EFF3"><a href="../sell/Sell3.aspx?Id=<%# Eval("Id") %>"><div class="bt">Edit</div></a></td>
                    <td bgcolor="#E4EFF3">
                         
                        <a href="MyGAT2.aspx?DeId=<%# Eval("Id") %>"><div class="bt">Delete</div></a></td>
                  </tr>
                </table> 
                         </ItemTemplate>
                    </asp:Repeater>
