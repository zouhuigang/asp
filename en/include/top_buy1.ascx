<%@ Control Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.en.include.top_buy1" %>
   <style type="text/css">

 
#nav {line-height: 24px;  list-style-type: none;  width:640px; margin:0px; padding:0px; font-size:14px!important;}
#nav li{ font-size:14px!important;}
#nav a {display: block; width: 140px; text-align:center; }

#nav a:link  {color:#000; text-decoration:none; font-size:14px!important;}
#nav a:visited  {color:#000;text-decoration:none; font-size:14px!important;}
#nav a:hover  {color:#000;text-decoration:none;  font-size:14px!important;}

#nav li {float: left;width:140px;height:43px; line-height:43px; font-size:14px!important;}
#nav li a:hover{background:url(../../images/11.png) no-repeat right center; width:140px; font-size:14px!important; }
#nav li ul {line-height: 27px;  list-style-type: none;text-align:left;left: -999em; width:260px; position: absolute; z-index:999;}
#nav li ul li{float: left; background:#EFEFEF;width:270px;margin-left:-40px; border-bottom:#C9C9C9 1px solid;}
...
#nav li ul a:hover  {color:#000;text-decoration:none;font-weight:normal;background:#dcdcdc;width:246px; }
...
<div class="top">
 ...
 <li ><a href="../sell/sell2.aspx">SELL AIRCRAFT</a>    <ul>
    <li> <a href="../sell/index.aspx" >Aircraft Brokers/Dealers</a></li>
         <!--<li> <a href="../sell/Sell3.asp">Aircraft Owners</a></li>
...
<li ><a href="#">MYGAT</a>
    ...
    <li > <a href="../sell/Sell3.aspx"  >Place a New Ad</a></li><%} %>
       <!-- <li  > <a href="../sell/Sell4.asp"  >Manage and Edit My ad</a></li>-->
