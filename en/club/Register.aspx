<%@ Page Language="C#" AutoEventWireup="true"  EnableEventValidation="false" Inherits="Aircraft.Web.en.club.Register" %>
...
<div id="page-wrap">
  <div id="example-two">
 	<ul class="nav">
		<li class="nav-one" onclick="window.location.href='index.aspx'"><a href="Index.aspx?ReturnUrl=<%=ReturnUrl %>"  ><img src="../../images/img37.png" width="25" height="25" style="vertical-align:text-bottom" /> Sign in</a></li>
		<li class="nav-two"><a href="#core2" class="current"><img src="../../images/img38.png" width="25" height="25" style="vertical-align:text-bottom"/> Register</a></li>
	</ul>
 	<div class="list-wrap">
 		<ul id="featured2" class="hide">
	...
	<li><a href="#">WANT TO JOIN AS A BUSINESS?</a></li>
