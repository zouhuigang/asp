<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Introduction.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                     ...
                                     <div class="control-group">  
                                        <label for="textfield" class="control-label">州名</label>
                                            <div class="controls">
                                                <asp:ListBox ID="Type" runat="server" Rows="1"> 
                                                </asp:ListBox>
										 </div>
									</div>
                                   <div class="control-group">  
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">推荐</label>
                                            <div class="controls">
                                                <asp:ListBox ID="Recommend" runat="server" Rows="1"> 
