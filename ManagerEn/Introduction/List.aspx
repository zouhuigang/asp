<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.ManagerEn.Introduction.List" %>
					...
					<div class="span12">
                        ...
                        <ItemTemplate>
										<tr id='tr_<%# Eval("Id") %>'>
                                            ...
                                            <td class="data-mun"><%# Eval("Type") %></td>
                                             <td class="data-mun"><%# Eval("CreateDate") %></td> 
                                              <td class="data-mun">
                                                <img  src="../../<%# Eval("Image") %>"  height="100"/> </td>
                                              <td class="data-mun"><%# Eval("Content") %></td> 
