<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Info.Edit" %>
...
<body>
	...
	<div class="container-fluid" id="content">
		<uc1:menu ID="menu" runat="server" Type="航空快讯"></uc1:menu>
		<div id="main">
								...
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">简介</label>
                                            <div class="controls">
                                         <asp:TextBox ID="Description" TextMode="MultiLine" style="width:600px;height:60px;" class="input-xlarge"  runat="server"></asp:TextBox>
										 </div>
									</div>
                                     <div class="control-group">  
