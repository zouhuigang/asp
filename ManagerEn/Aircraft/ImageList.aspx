<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.ManagerEn.Aircraft.ImageList" %>
			...
			<div class="container-fluid">
				...
				<div class="row-fluid">
					<div class="span12">
							...
							<div class="box-content nopadding" id="resText">
                                <table width="100%" cellSpacing="0" cellPadding="0" border="0">
                                    <tr>
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="location='ImageEdit.aspx?AircraftId=<%=AircraftId %>'">添加</button>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                        ...
                        <ItemTemplate>
										<tr id='tr_<%# Eval("Id") %>'>  
                                            <td class="data-mun" ><img src="../../<%# Eval("Image") %>"  style="height:100px;" /></td>  
											<td class="data-act"> 
                                            <a style="cursor: pointer;" onclick="return confirm('确认要删除吗?');" href="ImageList.aspx?AircraftId=<%=AircraftId %>&delid=<%# Eval("Id") %>" class="delt"><i class="icon-remove"></i> 删除</a>
                                            </td>
										</tr>
						</ItemTemplate>
					</asp:Repeater>
