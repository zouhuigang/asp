<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Aircraft.ImageEdit" %>
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                    ...
                                    <div class="control-group">
										<label for="textfield" class="control-label">图片<small>（570 x 430）</small></label>
										<div class="controls">
