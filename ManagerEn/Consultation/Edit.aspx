<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Consultation.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									...
									<div class="control-group">
										<label for="textfield" class="control-label">姓名</label>
										<div class="controls">
                                    ...
                                    <div class="control-group">
										<label for="textfield" class="control-label">行程目的</label>
										<div class="controls">
                                            <asp:Label ID="Target" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                    <div class="control-group">
										<label for="textfield" class="control-label">出发城市</label>
										<div class="controls">
                                            <asp:Label ID="City" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                    <div class="control-group">
										<label for="textfield" class="control-label">抵达城市</label>
										<div class="controls">
                                            <asp:Label ID="City1" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                    <div class="control-group">
										<label for="textfield" class="control-label">出发日期</label>
										<div class="controls">
                                            <asp:Label ID="Date" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                    <div class="control-group">
										<label for="textfield" class="control-label">返回日期</label>
										<div class="controls">
                                            <asp:Label ID="Date1" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                     <div class="control-group">
										<label for="textfield" class="control-label">乘客人数</label>
										<div class="controls">
                                            <asp:Label ID="Number" runat="server" Text="Label"></asp:Label>
										</div>
									</div>
                                     <div class="control-group">
										<label for="textfield" class="control-label">留言</label>
										<div class="controls">
                                     ...
                                     <div class="control-group">  
                                        <label for="textfield" class="control-label">状态</label>
                                            <div class="controls">
                                                <asp:ListBox ID="State" runat="server" Rows="1">
