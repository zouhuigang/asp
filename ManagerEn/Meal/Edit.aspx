<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Meal.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                    ...
                                    <div class="control-group">
										...
										<div class="controls">
                                            <asp:TextBox ID="Price" runat="server"  Text="0" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										</div>
									</div> 
                                     <div class="control-group">
                                    ...
                                    <div class="control-group">
										<label for="textfield" class="control-label">图片<small>（254 x 187）</small></label>
										<div class="controls">
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">是否显示</label>
                                            <div class="controls">
                                                <asp:ListBox ID="Show" runat="server" Rows="1">
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">是否可报名</label>
                                            <div class="controls">
                                                <asp:ListBox ID="Registration" runat="server" Rows="1">
                                                    <asp:ListItem>是</asp:ListItem>
                                                    <asp:ListItem>否</asp:ListItem>
                                                </asp:ListBox>
										 </div>
                                     ...
                                     <div class="control-group">  
                                        <label for="textfield" class="control-label">内容</label>
                                            <div class="controls">
                                         <asp:TextBox ID="Content" TextMode="MultiLine" style="width:600px;height:60px;" class="input-xlarge"  runat="server"></asp:TextBox>
										 </div>
									</div>
