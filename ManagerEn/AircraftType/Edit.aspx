<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.AircraftType.Edit" %>
						...
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
                                    ...
                                    <div class="control-group">
										<label for="textfield" class="control-label">显示顺序</label>
										<div class="controls">
                                            <asp:TextBox ID="ShowIndex" runat="server" Text="10" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">图片<small>（82 x 50）</small></label>
										<div class="controls">
