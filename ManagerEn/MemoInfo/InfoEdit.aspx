<%@ Page Language="C#" AutoEventWireup="true" ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.MemoInfo.InfoEdit" %>
...
<body>
	...
	<div class="container-fluid" id="content">
		<uc1:menu ID="menu" runat="server" Type="关于赞禾"></uc1:menu>
		<div id="main">
				...
				<div class="row-fluid">
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i> <%=TypeName %></h3>
							</div>
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									...
									<div class="control-group">
										<label for="editor1" class="control-label">内容</label>
										<div class="controls">
                                         <asp:TextBox ID="Content" TextMode="MultiLine" style="height:30px;"  runat="server"></asp:TextBox>
										</div>
									</div>
									<div class="form-actions">
                                        <asp:Button ID="btn_Ok" runat="server" Text="保存"   class="btn btn-primary" />
