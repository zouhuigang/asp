<%@ Page Language="C#" AutoEventWireup="true"  Inherits="Aircraft.Web.ManagerEn.Project.List" %>
							...
							<div class="box-content nopadding" id="resText">
                                <table width="100%" cellSpacing="0" cellPadding="0" border="0">
                                    <tr>
                                        ...
                                        <button type="button" class="btn btn-primary" onclick="location='Edit.aspx?Type=<%= tname %>'">添加</button>
                                        </td>
                                        <td>&nbsp;</td>
                                    </tr>
                                </table>
                        ...
                        <ItemTemplate>
										<tr id='tr_<%# Eval("Id") %>'>
                                            ...
                                            <td class="data-mun"><%# Eval("Subject") %></td>
                                             <td class="data-mun"><%# Convert.ToDateTime( Eval("CreateDate")).ToString("yyyy-MM-dd") %></td> 
											   <td class="data-mun"><%#  Convert.ToDateTime(Eval("SDate")).ToString("yyyy-MM-dd") %></td> 
                                              <td class="data-mun"><%#  Convert.ToDateTime(Eval("EDate")).ToString("yyyy-MM-dd") %></td> 
											<td class="data-act">
