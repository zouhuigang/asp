<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.Project.Edit" %>
...
<body>
	...
	<div class="container-fluid" id="content">
		<uc1:menu ID="menu" runat="server" Type="航空俱乐部"></uc1:menu>
		<div id="main">
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									...
									<div class="control-group">
                                     ...
                                     <div class="control-group">
										<label for="textfield" class="control-label">开始日期</label>
										<div class="controls">
                                            <asp:TextBox ID="SDate"  onclick="WdatePicker({ isShowClear: false, readOnly: true })"  runat="server" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										</div>
									</div>
                                     <div class="control-group">
										<label for="textfield" class="control-label">结束日期</label>
										<div class="controls">
                                            <asp:TextBox ID="EDate"  onclick="WdatePicker({ isShowClear: false, readOnly: true })"  runat="server" placeholder="" class="input-xlarge" style="width:300px;"></asp:TextBox>
										</div>
									</div>
                                    ...
                                    <div class="control-group">  
                                        <label for="textfield" class="control-label">内容</label>
                                            <div class="controls">
                                         <asp:TextBox ID="Description" TextMode="MultiLine" style="width:600px;height:260px;" class="input-xlarge"  runat="server"></asp:TextBox>
										 </div>
									</div>
