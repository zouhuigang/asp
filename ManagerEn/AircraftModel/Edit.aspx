<%@ Page Language="C#" AutoEventWireup="true"  ValidateRequest="false"  Inherits="Aircraft.Web.ManagerEn.AircraftModel.Edit" %>
							...
							<div class="box-content nopadding">
								<form id="form1" runat="server" class='form-horizontal form-striped'>
									  <div class="control-group">
										...
										<div class="controls">
                                            <asp:ListBox ID="Manufacturer" runat="server"  CssClass="input-xlarge" Rows="1"></asp:ListBox>
										</div>
									</div> 
									<div class="control-group">
